...
src/
  ...
  components/
    ui/
      ...
      ModalFecharConta.jsx      ← Modal reutilizável de fechar conta por cliente; props: client={name,clientId,tabs[]}, orders, ordersLoading, method, onMethodChange, paying, onClose, onConfirm; exibe skeleton enquanto carrega pedidos de produtos; lista serviços + produtos + total; seletor de método (4 botões); botão desabilitado durante ordersLoading; usado em AdminAgenda (context menu), MinhaAgenda (botão por card) e DetalhesAgendamento (botão "Fechar comanda")
